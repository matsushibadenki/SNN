...
class ConsoleLogger(LoggerProtocol):
    def log(self, data: Dict[str, Any], step: Optional[int] = None) -> None: pass 
...
def objective(trial: Trial) -> float:
    ...
    if train_loader is None or eval_loader is None: return -1.0
...
def main_hpo() -> None:
    global train_loader, eval_loader
    if not TORCH_AVAILABLE or not OPTUNA_AVAILABLE: return
