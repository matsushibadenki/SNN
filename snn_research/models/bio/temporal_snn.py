...
class SimpleRSNN(BaseModel):
    ...
    def __init__(
        ...
        self._init_weights()
        logger.info(f"✅ SimpleRSNN initialized (In: {input_dim}, Hidden: {hidden_dim}, Out: {output_dim})")
...
class GatedSNN(BaseModel):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._init_weights()
        logger.info(f"✅ GatedSNN (Spiking GRU) initialized.")
    ...
    def forward(
        ...
        **kwargs: Any
        ...
        if hasattr(self.lif_z, 'set_stateful'): cast(Any, self.lif_z).set_stateful(True)
        if hasattr(self.lif_r, 'set_stateful'): cast(Any, self.lif_r).set_stateful(True)
        if hasattr(self.lif_h, 'set_stateful'): cast(Any, self.lif_h).set_stateful(True)
        ...
        if hasattr(self.lif_z, 'set_stateful'): cast(Any, self.lif_z).set_stateful(False)
        if hasattr(self.lif_r, 'set_stateful'): cast(Any, self.lif_r).set_stateful(False)
        if hasattr(self.lif_h, 'set_stateful'): cast(Any, self.lif_h).set_stateful(False)
