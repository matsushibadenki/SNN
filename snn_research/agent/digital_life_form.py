...
class DigitalLifeForm:
    ...
    async def life_cycle_step(self):
        ...
        if not plan.task_list:
            plan.task_list = [{"task": "perform_active_inference", "description": "Explore environment"}]
        ...
        for task in plan.task_list:
            ...
            decision_context = {"goal": goal, "performance_eval": performance_eval}
    ...
    def _update_motivation(self, reward: float):
        ...
        motivation_sys = cast(IntrinsicMotivationSystem, self.motivation_system)
