...
# 他のモジュールから import Parameters できるように公開
...
# (型チェックおよびP1-1 具象化のデモンストレーション用)
class ExamplePredictiveCodingRule(AbstractLearningRule):
    """
    P1-1 (予測符号化) を実装する具象クラスの例。
    実運用には snn_research.core.learning_rules.predictive_coding_rule.PredictiveCodingRule を使用してください。
    """
    def __init__(self, params: Parameters, **kwargs: Any) -> None:
