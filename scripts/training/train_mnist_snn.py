...
def main():
    ...
    train_dataset = datasets.MNIST(root=CONFIG["dataset_path"], train=True, download=True, transform=transform)
    ...
    for epoch in range(CONFIG["epochs"]):
        ...
        logger.info(f"Epoch {epoch+1}: Test Acc={test_acc:.2f}%, Latency={avg_latency:.2f}ms, SpikeRate={avg_spike_rate:.1%}")
        ...
        if test_acc > best_acc:
            ...
            # Model Save
            torch.save(model.state_dict(), "workspace/results/best_mnist_snn.pth")
