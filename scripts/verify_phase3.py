...
def verify_sformer():
    ...
    try:
        ...
        logger.info(f"✅ SFormer Forward Pass Success.")
        ...
        if model.model.time_steps != 1:
            ...
            logger.info(f"✅ SFormer confirmed running at T=1.")
...
def verify_semm():
    ...
    try:
        ...
        logger.info(f"✅ SEMM Forward Pass Success.")
...
def verify_causal_perception():
    ...
    try:
        ...
        logger.info(f"✅ Visual Cortex Forward Pass Success.")
