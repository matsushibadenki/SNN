...
def run_scal_spiking_ff_sleep():
    ...
    for epoch in range(1, config['num_epochs'] + 1):
        ...
        for _ in range(sleep_iters):
            sleep_loss += trainer.train_sleep_phase(
                batch_size=64, noise_intensity=1.0)
    ...
    save_path = os.path.join(os.path.dirname(
        __file__), '../../../../results/checkpoints/spiking_ff_sleep.pth')
