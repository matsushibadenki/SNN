...
def run_coordination_demo():
    ...
    print(f"🧠 Brain initialized on {device.upper()}. ready for multimodal input.")
    ...
    text_inputs = tokenizer(text_prompt, return_tensors="pt").input_ids.to(device)
    ...
    print(f"🎬 [Vision Input]: Video sequence of an object falling (8 frames).")
    ...
    print(f"4. **Prediction**: The brain predicts the next concept is -> '{predicted_word.strip()}'")
