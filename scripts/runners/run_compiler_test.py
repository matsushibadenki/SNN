...
def main():
    ...
    # 1. コンパイラ初期化
    compiler = NeuromorphicCompiler(target_hardware="Matsushiba_Neuromorphic_Chip_v1")
    ...
    stats = compiler.compile(model, model_name="Brain_v20_Core")
    ...
    logger.info(f"   Required Cores:  {stats['core_mapping']['required_cores']}")
