...
def main():
    parser = argparse.ArgumentParser(description="Run Bio-Inspired Reinforcement Learning Agent")
    parser.add_argument("--episodes", type=int, default=100, help="Number of training episodes")
    parser.add_argument("--output_dir", type=str, default="workspace/runs/rl_experiment", help="Directory to save results")
    ...
    print(f"Final Average Reward: {results.get('final_average_reward', 0.0):.4f}")
