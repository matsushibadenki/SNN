# matsushibadenki/snn/scripts/data_preparation.py
#
...
#
# 変更点:
# - 生成ファイルとキャッシュを workspace ディレクトリに集約。
...
def prepare_wikitext_data(output_dir: str = "workspace/data", cache_dir: str = "workspace/cache"):
    """
