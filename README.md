...
\# 人工脳の起動 (計算タスクの依頼)  
python run\_brain\_simulation.py \--model\_config configs/models/my\_moe.yaml \--prompt "1+1の計算をして"
...
* snn\_research/: コアライブラリ  
  * core/models/moe\_model.py: FrankenMoEの実装  
  * cognitive\_architecture/rag\_snn.py: GraphRAGの実装  
  * architectures/spiking\_rwkv.py: 1.58bit RWKVの実装  
